...
async def _call_gemini(system_prompt: str, user_prompt: str) -> str:
    """
    Single entry-point to call the LLM asynchronously.
    Now attempts GROQ as primary, and falls back to Gemini keys and fallback models.
    ...
    if groq_api_key:
        try:
            ...
            logger.warning("Groq failed with model %s: %s. Falling back to Gemini...", groq_model, e)
            last_exception = e
